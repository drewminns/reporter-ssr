...
const css = {
	code: "h1.svelte-1440tcg{color:blue}",
	map: "{\"version\":3,\"file\":\"About.svelte\",\"sources\":[\"About.svelte\"],\"sourcesContent\":[\"<style lang=\\\"scss\\\">h1 {\\n  color: blue; }\\n\\n/* your styles go here */\\n\\n/*# sourceMappingURL=About.svelte.css.map */</style>\\n\\n<h1>About</h1>\\n<p>I like to code</p>\\n\"],\"names\":[],\"mappings\":\"AAAmB,EAAE,eAAC,CAAC,AACrB,KAAK,CAAE,IAAI,AAAE,CAAC\"}"
};

const About = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css);

	return `<h1 class="svelte-1440tcg">About</h1>
	<p>I like to code</p>`;
});
...
const css$1 = {
	code: "div.svelte-xvzyu0{background:blue}div.svelte-xvzyu0 nav.svelte-xvzyu0{background:green}",
	map: "{\"version\":3,\"file\":\"App.svelte\",\"sources\":[\"App.svelte\"],\"sourcesContent\":[\"<script>\\n  import { Router, Route } from 'svelte-routing';\\n\\n  import NavLink from './components/NavLink.svelte';\\n  import Home from './routes/Home.svelte';\\n  import About from './routes/About.svelte';\\n  import Blog from './routes/Blog.svelte';\\n\\n  // Used for SSR. A falsy value is ignored by the Router.\\n  export let url = '';\\n</script>\\n\\n<style lang=\\\"scss\\\">div {\\n  background: blue; }\\n  div nav {\\n    background: green; }\\n\\n/*# sourceMappingURL=App.svelte.css.map */</style>\\n\\n<div>\\n  <Router {url}>\\n    <nav>\\n      <NavLink to=\\\"/\\\">Home</NavLink>\\n      <NavLink to=\\\"about\\\">About</NavLink>\\n      <NavLink to=\\\"blog\\\">Blog</NavLink>\\n    </nav>\\n    <div>\\n      <Route path=\\\"about\\\" component={About} />\\n      <Route path=\\\"blog\\\" component={Blog} />\\n      <Route path=\\\"/\\\" component={Home} />\\n    </div>\\n  </Router>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAYmB,GAAG,cAAC,CAAC,AACtB,UAAU,CAAE,IAAI,AAAE,CAAC,AACnB,iBAAG,CAAC,GAAG,cAAC,CAAC,AACP,UAAU,CAAE,KAAK,AAAE,CAAC\"}"
};
...
const App = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  let { url = '' } = $$props;
	...
	return `<div class="svelte-xvzyu0">
	  ${validate_component(Router, 'Router').$$render($$result, { url: url }, {}, {
		default: () => `
	    <nav class="svelte-xvzyu0">
